import { formCrearUsuario } from "@/app/utils/dataforms/dataForms";
import { handleApiReniec } from "@/app/utils/functions/handleApiReniec";
import { Autocomplete, TextField } from "@mui/material";
import moment from "moment-timezone";
import { Controller } from "react-hook-form";

export const FormCrearUsuario = ({ getValues, setValue, handleSubmit, control, apiCall, loading, error }: any) => {

    return (
        <>
            <div className="flex flex-col gap-3">
                {
                    formCrearUsuario?.map((item, index) => {
                        return (
                            <>
                                {
